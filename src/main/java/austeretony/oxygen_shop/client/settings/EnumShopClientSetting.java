...
public enum EnumShopClientSetting {

    //Oxygen Menu

    ADD_SHOP_MENU("menu_add_shop_menu", EnumValueType.BOOLEAN, String.valueOf(true));
    ...
    EnumShopClientSetting(String key, EnumValueType type, String baseValue) {
        this.key = key;
        this.type = type;
    ...
    public static void register() {
        for (EnumShopClientSetting setting : values())
