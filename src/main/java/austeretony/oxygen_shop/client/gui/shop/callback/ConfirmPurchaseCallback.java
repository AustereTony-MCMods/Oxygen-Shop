package austeretony.oxygen_shop.client.gui.shop.callback;
...
import austeretony.oxygen_shop.client.gui.shop.ShopSection;
...
public class ConfirmPurchaseCallback extends AbstractGUICallback {
    ...
    public ConfirmPurchaseCallback(ShopMenuScreen screen, ShopSection section, int width, int height) {
    ...
    public void init() {
        ...
        this.addElement(new OxygenTextLabel(4, 12, ClientReference.localize("oxygen_shop.gui.shop.callback.confirmPurchase"), EnumBaseGUISetting.TEXT_SCALE.get().asFloat(), EnumBaseGUISetting.TEXT_ENABLED_COLOR.get().asInt()));
        this.addElement(new OxygenTextLabel(6, 23, ClientReference.localize("oxygen_shop.gui.shop.callback.confirmPurchase.request"), EnumBaseGUISetting.TEXT_SUB_SCALE.get().asFloat(), EnumBaseGUISetting.TEXT_ENABLED_COLOR.get().asInt()));
